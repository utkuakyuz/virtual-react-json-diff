...
import { VariableSizeList as List, type ListChildComponentProps, type ListOnScrollProps } from "react-window";
import { type DiffResult, Differ, Viewer } from "json-diff-kit";
import { DiffMinimap } from "./DiffMinimap";
import { VirtualizedDiffViewerProps, SegmentItem, SearchState, DiffRowOrCollapsed } from "../types";
import { performSearch, highlightMatches } from "../utils/diffSearchUtils";
import { generateSegments, buildViewFromSegments } from "../utils/preprocessDiff";
...
const isCollapsed = (line: any): line is { type: "collapsed"; segmentIndex: number } =>
    line && typeof line === "object" && "type" in line && line.type === "collapsed";
...
export const VirtualizedDiffViewer: React.FC<VirtualizedDiffViewerProps> = ({
    ...
    const handleExpand = useCallback((segmentIndex: number) => {
        setSegments((prev) => {
            ...
            if (!seg || !seg.isEqual) return prev;
                    ...
                    <div className="search-container">
                        ...
                        {searchState.results.length > 0 && (
                            <div className="search-results">
                                <span>
                                    {searchState.currentIndex + 1} of {searchState.results.length} matches
                                </span>
